...
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $OutputPath = Join-Path $workspaceRoot 'deliverables\CAS-Pixel11-Windows-Test-Kit-v2.zip'
}
...
$stagedPackage = Join-Path $stagingRoot 'CAS-Pixel11-Windows-Test-Kit-v2'
try {
